# created by Lin Peng in 2021.05.23 16:15
import matplotlib
...
if __name__ == "__main__":
    ...
    parser.add_argument("--driving_video", default='./demo/output.MP4', help="path to driving video")
    parser.add_argument("--result_video", default='./result/result1.mp4', help="path to output")
    ...
    out = cv2.VideoWriter('./demo/output.MP4', fourcc, 20.0, (640, 480))
